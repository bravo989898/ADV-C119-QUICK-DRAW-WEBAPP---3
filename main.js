...
rand_number = Math.floor((Math.random() * quick_draw_data_set.length) + 1);
console.log("Sl no. :" + rand_number);
sketch = quick_draw_data_set[rand_number];
console.log(sketch);
...
function gotResult(error, results) {
    ...
    if (sketch == drawn_sketch){
        utterThis = new SpeechSynthesisUtterance("yes I got it");
...
function check_sketch(){
    timer_counter++;
    act_timer = Math.floor(timer_counter/100);
    document.getElementById("timer").innerHTML = "Timer :"+ " " + act_timer + "s";
    console.log(act_timer);
